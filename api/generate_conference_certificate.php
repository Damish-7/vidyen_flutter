<?php
/**
 * Conference Certificate Preview
 */
session_start();
include('config.php');
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="card-title mb-0">Conference Participation Certificate Preview</h4>
            <a href="generate_conference_certificate_download.php" class="btn btn-success">
          ...
          <div class="certificate-preview" style="position: relative; width: 100%; max-width: 1200px; margin: 0 auto;">
            ...
            <div class="certificate-container">
              <img src="certificates/conference_participation.jpg" alt="Conference Certificate" />
